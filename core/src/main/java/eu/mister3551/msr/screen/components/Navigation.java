    ...
    public Table back(Skin skin, String screenName) {
        ...
        if (screenName != null) {
            ...
            textButtonBack.addListener(new InputListener() {
                @Override
                public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                    Static.screenChanger.changeScreen(screenName);
                    return true;
                }
            });
    ...
    public Table menu(Skin skin, Popup popup) {
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                Static.data.gear(new Callback() {
                    @Override
                    public void onSuccess(Object object) {
                        Static.gears = (ArrayList<Gear>) object;
                        Gdx.app.postRunnable(() -> {
                            popup.close();
                            Static.screenChanger.changeScreen("GearScreen");
                        });
                    }
