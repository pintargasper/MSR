...
public class Popup {
    ...
    public Table loadingPopup(Skin skin) {
        ...
        float viewportWidth = Static.stage.getViewport().getWorldWidth();
        float viewportHeight = Static.stage.getViewport().getWorldHeight();
    ...
    public Table optionsSelectPopup(Skin skin, TextButton textButtonKey) {
        ...
        Static.stage.addListener(new InputListener() {
            @Override
    ...
    public Table missionDetailsPopup(Skin skin, Mission mission) {
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                close();
                if (isOpen()) {
                    Static.stage.addActor(loadingPopup(skin));
                }
                Static.data.options(new Callback() {
                    @Override
                    ...
                    public void onError(String errorMessage) {
                        Gdx.app.postRunnable(() -> {
                            ...
                            if (isOpen()) {
                                Static.stage.addActor(errorPopup(skin, errorMessage));
                            }
    ...
    public Table pausePopup(Skin skin, GameScreen gameScreen) {
        ...
        label = new Label(String.valueOf(Static.statistics.getScore()), skin);
        label.setAlignment(Align.center);
        table2.add(label).padLeft(5.0f).minWidth(70.0f).maxWidth(70.0f);
        table1.add(table2).minWidth(200.0f).maxWidth(200.0f);
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                close();
                Static.screenChanger.changeScreen("MissionScreen");
                return true;
            }
        });
        table2.add(textButton);
    ...
    public Table missionCompletePopup(Skin skin, GameScreen gameScreen) {
        ...
        label = new Label(Static.statistics.getMoney().getOrDefault("total", 0.0f) + "€", skin);
        label.setAlignment(Align.center);
        table2.add(label).padLeft(5.0f).minWidth(70.0f).maxWidth(70.0f);
        table1.add(table2).minWidth(200.0f).maxWidth(200.0f);
        ...
        label = new Label(Static.statistics.getMoney().getOrDefault("hostages", 0.0f) + "€", skin);
        label.setAlignment(Align.center);
        table2.add(label).padLeft(5.0f).minWidth(70.0f).maxWidth(70.0f);
        table1.add(table2).minWidth(200.0f).maxWidth(200.0f);
        ...
        label = new Label(Static.statistics.getMoney().getOrDefault("enemies", 0.0f) + "€", skin);
        label.setAlignment(Align.center);
        table2.add(label).padLeft(5.0f).minWidth(70.0f).maxWidth(70.0f);
        table1.add(table2).minWidth(200.0f).maxWidth(200.0f);
        ...
        label = new Label(Static.statistics.getMoney().getOrDefault("ammoCosts", 0.0f) + "€", skin);
        label.setAlignment(Align.center);
        table2.add(label).padLeft(5.0f).minWidth(70.0f).maxWidth(70.0f);
        table1.add(table2).minWidth(200.0f).maxWidth(200.0f);
        ...
        textButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                if (Static.popup.isOpen()) {
                    Static.stage.addActor(Static.popup.loadingPopup(skin));
                }
                Static.data.missions(new Callback() {
                    @Override
                    public void onSuccess(Object object) {
                        Static.missions = (ArrayList<Mission>) object;
                        Gdx.app.postRunnable(() -> {
                            Static.popup.close();
                            Static.screenChanger.changeScreen("MissionScreen");
                        });
                    ...
                    public void onError(String errorMessage) {
                        Gdx.app.postRunnable(() -> {
                            ...
                            if (Static.popup.isOpen()) {
                                Static.stage.addActor(Static.popup.errorPopup(skin, errorMessage));
                            }
                        });
                    }
                });
    ...
    public void resize(int width, int height) {
        if (table != null) {
            if (Gdx.app.getType() == Application.ApplicationType.Android) {
                width = (int) Static.stage.getViewport().getWorldWidth();
                height = (int) Static.stage.getViewport().getWorldHeight();
            }
    ...
    public void close() {
        Array<Actor> actors = Static.stage.getActors();
