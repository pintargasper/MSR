...
public class OptionsScreen implements Screen {
    ...
    public OptionsScreen() {
        ...
        this.navigation = Static.navigation;
    ...
    public void show() {
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Gdx.net.openURI("https://msr.gasperpintar.com/" + Static.account.getUsername());
                return true;
            }
        });
        ...
        textButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Gdx.net.openURI("https://msr.gasperpintar.com/" + Static.account.getUsername() + "/settings");
                return true;
            }
        });
        table3.add(textButton).minWidth(100.0f).minHeight(30.0f).maxWidth(100.0f).maxHeight(30.0f);
        ...
        textButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Static.screenChanger.changeScreen("SignInScreen");
                return true;
            }
        });
        table3.add(textButton).minWidth(100.0f).minHeight(30.0f).maxWidth(100.0f).maxHeight(30.0f);
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                Static.data.updateOptions(options, new Callback() {
