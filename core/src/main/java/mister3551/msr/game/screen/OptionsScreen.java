...
public class OptionsScreen implements Screen {
    ...
    public OptionsScreen() {
        ...
        this.options = Static.getOptions();
    }
    ...
    public void show() {
        ...
        selectBox.setSelected(setLanguage(options.getLanguage()));
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Gdx.net.openURI("https://msr.gasperpintar.com/" + Static.getAccount().getUsername());
                return true;
            }
        });
        ...
        textButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Gdx.net.openURI("https://msr.gasperpintar.com/" + Static.getAccount().getUsername() + "/settings");
                return true;
            }
        });
        table3.add(textButton).minWidth(100.0f).minHeight(30.0f).maxWidth(100.0f).maxHeight(30.0f);
        ...
        textButton.addListener(new InputListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Static.getScreenChanger().changeScreen("SignInScreen");
                return true;
            }
        });
        table3.add(textButton).minWidth(100.0f).minHeight(30.0f).maxWidth(100.0f).maxHeight(30.0f);
        ...
        textButton.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                options.setLanguage(getLanguageMark(selectBox.getSelected()));
                ...
                Static.getData().updateOptions(options, new Callback() {
    ...
    private String setLanguage(String mark) {
        switch (mark) {
            case "SI":
                mark = "Slovenscina";
                break;
    ...
    private String getLanguageMark(String text) {
        switch (text) {
            case "Slovenscina":
                text = "SI";
                break;
